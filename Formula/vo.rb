class Vo < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/vo-lang/volang/releases/download/v0.1.3/vo-aarch64-apple-darwin.tar.gz"
      sha256 "b98c9143e5acd2fe575ef0ecb79244f0d81d9acd3a726db9aeebb7400aa215b7"
    end
    on_intel do
      url "https://github.com/vo-lang/volang/releases/download/v0.1.3/vo-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_arm do
      if Hardware::CPU.is_64_bit?
        url "https://github.com/vo-lang/volang/releases/download/v0.1.3/vo-aarch64-unknown-linux-gnu.tar.gz"
        sha256 "20301cdf425a83be57421faca5323835c8864288c1b3a19b3d2c72cbb1afb008"
      end
    end
    on_intel do
      url "https://github.com/vo-lang/volang/releases/download/v0.1.3/vo-x86_64-unknown-linux-gnu.tar.gz"
